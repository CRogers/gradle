...
class DefaultLocalConfigurationMetadataBuilderTest extends Specification {
    ...
    def "adds ModuleDependency instances from configuration"() {
        ...
        1 * dependencyMetadataFactory.createDependencyConstraintMetadata(componentId, "config", _, dependency1) >> dependencyDescriptor1
        1 * dependencyMetadataFactory.createDependencyConstraintMetadata(componentId, "config", _, dependency2) >> dependencyDescriptor2
